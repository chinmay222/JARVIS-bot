...
def find_list_in_list(list, dict):
    for word in list:
        for keys in dict.keys():
            if word == keys:
                return dict[word]

    return "This item is not available in campus"
...
eatchoices = {
    "cake": "The best place to eat that would be BITS & BYTES",
    "maggi": 'You should try that at YUMPPIES',
    "lunch": "Elephant serves the best lunch",
    "dinner": "Elephant serves the best dinner",
    "pizza": "BITS & BYTES serve delicious pizza",
    "burger": "BITS & BYTES serve delicious burger",
    "snacks": "C3 offers variety of snacks",
    "biscuits": "MORE offers variety of biscuits",
    "chocolates": "MORE offers variety of chocolates",
    "dosa": "CAFETERIA makes really good dosas",
    "idli": "CAFETERIA makes really good idli"
}
...
while True:
    ...
    if find_in_list(input_list, 'weather'):
        ...
        print('Temperature : {:.5} °C '.format(str(json_data['main']['temp'] - 273.15)))
    # time and location:
        ...
        if condition == 1:
            ...
            for i in range(1, 6):
                ...
                print()
                print()
    elif find_in_list(input_list, "eateries") or (find_in_list(input_list,"suggest") and find_in_list(input_list,"eat")) or (find_in_list(input_list,"want") and find_in_list(input_list,"eat")) or (find_in_list(input_list,"bits") and find_in_list(input_list,"eat")):
        eat_input = input("Please enter the item you want to eat >>")
        eat_input_list = eat_input.split()
        print(find_list_in_list(eat_input_list, eatchoices))
